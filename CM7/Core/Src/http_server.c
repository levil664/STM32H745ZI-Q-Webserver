...
static const char http_index_html[] = "<html><head><title>УРА!</title></head><body><h1>Поднятый сервер!</h1><p>При использовании httpserver-netconn</body></html>";

static const char http_404_hdr[] = "HTTP/1.1 404 ERROR\r\nContent-type: text/html\r\n\r\n";
static const char http_404_html[] = "<html><head><title>Ошибка</title></head><body><h1>LWIP Ошибка</h1><p>Тут ничего нет</body></html>";
